...
- (FaceppResult *)detectEyesWithFaceID:(NSString *)face_id
{
    NSMutableArray *param = [NSMutableArray arrayWithCapacity:2];
    [param addObject:@"face_id"];
    [param addObject:face_id];
    return [FaceppClient requestWithMethod:@"detection/landmark" image:nil params:param];
}
